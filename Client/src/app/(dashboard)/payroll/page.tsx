      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start gap-3 rounded-lg border border-amber-200 bg-amber-50 p-4 text-amber-800 dark:border-amber-800/30 dark:bg-amber-900/20 dark:text-amber-400">
          ...
          <div className="text-sm">
            ...
            Connect to{" "}
            <code className="rounded bg-amber-100/50 px-1 dark:bg-amber-900/40">
              GET /api/v1/payroll
            </code>{" "}
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                ETB{" "}
                {staff
                  .reduce((sum, p) => sum + p.calculated_pay, 0)
                  .toLocaleString()}
              </div>
            </CardContent>
          </Card>
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {staff.filter((p) => p.status === "pending").length}
              </div>
            </CardContent>
          </Card>
        </div>
                  ...
                  filtered.map((s) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        ETB {s.base_salary.toLocaleString()}
                      </td>
